    ...
    <div class="container">
      ...
      <div class="hero min-h-screen bg-base-100">
        <div class="hero-content flex-col lg:flex-row-reverse">
          ...
          <div>
            <h1 class="text-5xl font-bold">Order  Dashboard</h1>
            <br/>
            <button class="btn btn-primary" onclick="goToOrder()">Create Order</button>    
            <br/>
      ...
      <table class="table table-xs">
		...
		?>
          ...
          <td><?php echo $row['mobile'] ?></td>
					<td>
          <a href="updateorder.php?ID=<?php echo $row['ID']; ?>"><button class="btn">Edit</button></a>
          <a href="deleteorder.php?ID=<?php echo $row['ID']; ?>"><button class="btn">Delete</button></a>
...
<script>
    function goToOrder() {
        window.location.href = 'createorder.php'; // Corrected 'login.php' to 'login.php'
    }
</script>
